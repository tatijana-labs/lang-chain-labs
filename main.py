...
def main():
    ...
    information ="""
    Elon Reeve Musk (/ˈiːlɒn/ EE-lon; born June 28, 1971) is a businessman and public official known for his leadership of Tesla and SpaceX. Musk has been the wealthiest person in the world since 2025; as of May 2026, Forbes estimates his net worth to be US$839 billion (March 2026).[2][3]
    ...
    summary_template = """
    given the information about a person below, create:
    1. A short summary
